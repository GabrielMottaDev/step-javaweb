...
public class AuthenticationPhaseListener implements PhaseListener {
    ...
    /**
     * <p>
     * The outcome to trigger navigation to the login page.</p>
     */
     ...
     * login view, otherwise all the user to continue to the requested view.</p>
     *
     * <p>
     * Implementation Note: We do this in the <code>afterPhase</code> to make
     * use of the <code>NavigationHandler</code>.</p>
     */
