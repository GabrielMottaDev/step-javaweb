...
/**
 * <p>
 * This entity provides a very basic representation of a web application
 * user.</p>
 *
 * <p>
 * This code was generated by NetBeans 5.5 DEV.</p>
 *
 * @author rlubke
 */
@Entity
...
@NamedQueries({
    ...
    @NamedQuery(name = "Wuser.findAll", query = "SELECT w FROM Wuser w WHERE w.id >= :id")
})
